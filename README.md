...
* 1x Открытие **Life Control MCLH-04**: отвратительные гигантские датчики с дорогой батарейкой, не рекомендую. Плохо срабатывает закрытие при низком уровне сигнала. Стоит на дверях на кухню.
