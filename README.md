...
* 2x **Aqara WS-EUK02**: хороший выключатель, практически всегда работает без "конденсатора", одна из кнопок у меня отвязана от реле.
* 2x **[Sonoff ZBM5]**: тактильно чуть хуже акары, в остальном норм. Может работать как с нулём, так и без нуля.
* 2x **[eWeLink ZB-SW01/SW02](https://aliexpress.ru/item/4001331194955.html)**: с этих выключателей начался мой умный дом :) Минусы: спамят в эфир, отвратительны тактильно, яркие светодиоды (заглушил каптоновым скотчем), часто нужен конденсатор (идёт в комплекте). Спам в эфир решается [альтернативной прошивкой](./zha-quirks/ewelink/firmware/).
...
* 1x Открытие **Yandex YNDX‑00520**: дверь в кладовку.
* 1x Открытие **Moes ZSS-S01-GWM-C-MS**: балкон на кухне.
* 2x Открытие **Life Control MCLH-04**: отвратительные гигантские датчики с дорогой батарейкой, не рекомендую. Плохо срабатывает закрытие при низком уровне сигнала. Стоит на дверях на кухню и определяет парковку обеденного столика.
* 7x Открытие **Perenio PECWS01**: дешевая альтернатива Xiaomi, работают хорошо, большой диапазон магнита. Надпись Perenio стирается ацетоном. Стоят на окнах и балконных дверях (не дают шторам работать при открытых окнах), и ещё на дверях в холодильник, морозильник и "крыльцо". Спустя год эксплуатации был обнаружен **огромный минус** - теряют прошивку и окирпичиваются при умирании батарейки ([способ починить](https://t.me/zigbeer/403683))
* 11x Движение **Xiaomi RTCGQ01LM/RTCGQ11LM/RTCGQ12LM**: разбросаны по всему дому, несколько с [перемычкой](https://community.smartthings.com/t/making-xiaomi-motion-sensor-a-super-motion-sensor/139806) для ускорения срабатывания. Применёна хитрость с переворачиванием чтобы не ловили котов (см. [диаграмму направленности](https://smarthomeinfo.ru/wp-content/uploads/2020/09/dalnost-obnarujenia.jpg)).
* 1x Присутствие **Aqara RTCZCGQ11LM (FP1)**: безупречно определяет присутствие по всей ванной комнате, жаль стоит дорого :(
...
* 1x Вибрация **Aqara DJT12LM**: гладильная доска

## Розетки

Все розетки с мониторингом энергопотребления (я угораю по бессмысленным дашбордам :)). WiFi розетки все на esphome, у меня аллергия на Тую.
...
* 2x WiFi **[Tuya Noname T34](https://www.wildberries.ru/catalog/142695350/detail.aspx?size=241147262)**, нужен фен для перепрошивки (uart не в доступе): Станция Дуо Макс (бесит светить ночью экраном), зарядка пылесоса
* 1x WiFi **[Tuya Noname T34](https://www.wildberries.ru/catalog/730475484/detail.aspx?size=1032772134)** зелёная плата: мастерская (увлажнители, станция)
* 4x WiFi **BSD33** на LN882H: увлажнитель в гостиной (допзащита для наливатора), увлажнители в мастерской, стол в спальне, зарядка телефонов
* 2x WiFi **[Tuya BSD34-MK](https://ozon.ru/t/ueAr1bm)**: бризеры в спальне и гостиной
* 1x WiFi **ATMT/WB2S**: стол в мастерской
* 1x WiFi **ATMT/T1**: изначально была розеткой на Zigbee с тупящим мониторингом, чип заменён на T1 из другой розетки и прошит esphome. Стоит на вентиляторе в гостиной.
* 1x WiFi [DIY из розетки + ESP8266](./images/plug-conversion.jpg), родной чип розетки умер во время экспериментов, пришлось собрать небольшого монстра на еспхе, и засунуть всё это в коробку: бризер в мастерской
...
* Вентилятор **Mijia Smart Tower Fan 2 BPTS02DM**: временный костыль для охлаждения гостиной, пока в ней не будет сделан ремонт и не установлен кондей.

## Замки

* **Danalock 3 Zigbee + BT**: в общий тамбур, соседи ходят по физически ключам.
* **[TTLock Ultra Black](http://ttlock.com.ru/shop/ttlock-motorlock-ultra/)**: в квартиру, открываем только отпечатками. Интегрируется через великолепный [компонент для esphome](https://github.com/bazuchan/esphome-ttlock) от @bazuchan.
...
* Учёт потребления воды кухонными счётчиками Itelma и осмосом Гейзер Престиж (вход/выход) + TDS + подсветка под кухонными шкафами: крутилка YF-S402B + [ESP32](./esphome/kitchen-water-meter.yaml) ([фото](images/water-filter-26.jpg))
...
3. Чувствительно к сопротивлению на ригеле. Ригель должен ходить свободно. Малейшее сопротивление - замок перестаёт вращать. Поэтому если ригель задевает за коробку - напильник в руки и точить.
4. Гигантский резервный ключ. Но мне пофиг, я ключ спрятал в стратегическом месте (тссс).
5. Есть [вопросики к безопасности](https://alephsecurity.com/2024/03/07/kontrol-lux-lock-2/).
...
5. Со временем уплывает калибровка из-за загрязнения энкодера. Лечится [спиртовыми ваннами](https://4pda.to/forum/index.php?showtopic=1079904&view=findpost&p=127592113).
