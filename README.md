...
* 4x **[eWeLink ZB-SW01/SW02](https://aliexpress.ru/item/4001331194955.html)**: с этих выключателей начался мой умный дом :) Минусы: спамят в эфир, отвратительны тактильно, яркие светодиоды (заглушил каптоновым скотчем), часто нужен конденсатор (идёт в комплекте). Спам в эфир решается [альтернативной прошивкой](./zha-quirks/ewelink/firmware/).
...
* Zigbee устройств: 51 на Z2M + 23 на ZHA = 74
