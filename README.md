...
* 3x Дым **GS SSHM-I1**
* 1x PM 2.5 **IKEA E2014 Vindriktning**: обогащён ESP8266 (Wemos). Неудачная попытка ловить когда сосед курит и его мерзкий дым затягивает в приточку. Датчик дым не видит :(
