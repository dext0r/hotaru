...
* 1x **[Sonoff ZBM5]**: тактильно чуть хуже акары, в остальном норм. Может работать как с нулём, так и без нуля.
* 3x **[eWeLink ZB-SW01/SW02](https://aliexpress.ru/item/4001331194955.html)**: с этих выключателей начался мой умный дом :) Минусы: спамят в эфир, отвратительны тактильно, яркие светодиоды (заглушил каптоновым скотчем), часто нужен конденсатор (идёт в комплекте). Спам в эфир решается [альтернативной прошивкой](./zha-quirks/ewelink/firmware/).
...
* Zigbee устройств: 37 на Z2M + 38 на ZHA = 75
* Esphome устройств: 55
* BLE датчики: 7
* Matter на WiFi: 1
* Камер на WiFi: 2
